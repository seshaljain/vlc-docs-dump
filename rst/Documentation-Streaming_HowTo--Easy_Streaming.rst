   *This page is outdated. Please see*\ `Documentation:Streaming HowTo New#Streaming using the GUI <Documentation:Streaming_HowTo_New#Streaming_using_the_GUI>`__\ *for updated streaming tutorials.*
